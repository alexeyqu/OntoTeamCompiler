...
#line 153 "grammar.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "NUM", "INT", "IF", "ELSE", "RETURN",
  "SEMI", "COMMA", "STAR", "NOT", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "ID", "STRING", "$accept", "commands", "command", "any_command", YY_NULLPTR
};
#endif
